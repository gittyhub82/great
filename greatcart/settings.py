...
SECRET_KEY = 'django-insecure-edhdr=1x-sju4-fa)yfngvam2!%=*msg4rqm394iw412q^%u8s'
...
# telling django that we are using custom user model
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # register the context processor of the cart_count
